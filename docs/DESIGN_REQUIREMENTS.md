...
| Spotlight the active read | The freshest book is the hero: largest on the shelf (widest slot, tallest cover), gold halo, ink-dark "last entry" bubble with gold text, and a one-time peek nudge on arrival. | Size is the strongest visual-prominence cue; one-time motion draws the eye without nagging; owner: it must "stand out the most", gold-on-wood bubble lacked contrast. | Shipped 2026-08-22 | D-023, D-024 |
...
| Finish / reopen a book | "🏁 I finished this book" beside Edit details; finishing celebrates with a toast and the shelf's gold treatment; undo is one tap, no ceremony. | Completion celebration without guilt; books-finished is the roadmap's primary metric. | Shipped 2026-08-22 | D-023 |
